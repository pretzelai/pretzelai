...
export const providersInfo: IProvidersInfo = {
  ...
  Anthropic: {
    ...
    models: {
      'claude-3-5-sonnet-20240620': {
        ...
        description: 'The best model from Anthropic. Fast and highly capable, better than GPT-4 series of models.',
        canBeUsedForChat: true,
        canBeUsedForInlineCompletion: true,
        canBeUsedForImages: true
      },
  ...
  Groq: {
    displayName: 'Groq',
    description:
      'Incredibly fast AI models based on open source LLMs. Some models are not available for general use - please make sure you have access',
    models: {
